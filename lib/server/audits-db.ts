  ...
  return [
    {
      ...
      aboutOrganization:
        "XXX is a global pharmaceutical company with annual revenues of approximately USD 1 billion and a strong international presence across 18 countries. The company operates across diverse pharmaceutical markets and is supported by an expanding portfolio of products, capabilities, and strategic partnerships.\n\nWith a focus on quality, innovation, operational excellence, and responsible growth, XXX serves customers and healthcare stakeholders across multiple geographies. Its global footprint, diversified operations, and commitment to regulatory compliance position the company as a significant participant in the international pharmaceutical industry.\n\nAs the organization continues to scale, effective governance, workforce capability, regulatory readiness, digital transformation, and robust risk-management practices remain critical to sustaining long-term growth and strengthening organizational resilience.",
    ...
    },
    {
      ...
      aboutOrganization: "ZZZ is a mid-sized organization currently under HR governance review.",
      department: "Human Resources",
      auditorName: "AAA",
      auditorDesignation: "HR Manager",
    ...
    },
    {
      ...
      aboutOrganization: "SSS is a mature organization with a well-established HR governance framework.",
      department: "Human Resources",
      auditorName: "BBB",
      auditorDesignation: "HR Manager",
    ...
    },
    {
      ...
      aboutOrganization: "CCC is an early-stage organization building out its HR governance practices.",
      department: "Human Resources",
      auditorName: "DDD",
      auditorDesignation: "HR Manager",
