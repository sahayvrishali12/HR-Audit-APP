...
function seedAudits(): AuditRecord[] {
  return [
    ...
    },
    {
      ...
      aboutOrganization: "Solstice Retail Group is a mid-sized retail organization currently under HR governance review.",
      department: "Human Resources",
    ...
    },
    {
      ...
      aboutOrganization: "Ashford & Cole Manufacturing is a mature organization with a well-established HR governance framework.",
      department: "Human Resources",
      auditorName: "Priya Nair",
      auditorDesignation: "HR Manager",
    ...
    },
    {
      ...
      aboutOrganization: "Norwood Logistics is an early-stage organization building out its HR governance practices.",
      department: "Human Resources",
